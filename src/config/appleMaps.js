...
module.exports = {
    ...
    keyId: process.env.APPLE_MAPS_KEY_ID || 'C87YKL88HG',
    mapsId: process.env.APPLE_MAPS_ID || 'maps.com.cotaja.app',

    // Path to the .p8 private key file
    privateKeyPath: process.env.APPLE_MAPS_KEY_PATH || path.join(__dirname, '../../certificates/AuthKey_C87YKL88HG.p8'),
